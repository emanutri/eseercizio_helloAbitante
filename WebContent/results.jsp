...
<body>
	<table class="center">
		...
		<% List<Abitante> listaDaServlet = (List<Abitante>)request.getAttribute("listAbitantiAttributeName");
				...
				<tr>
					...
					<td>
						...
						<a href="PrepareModificaAbitante?idDaInviareComeParametro=<%=abitanteItem.getIdAbitante() %>">Modifica</a>
		...
		<tfoot>
			<tr>
				<td><form action="PrepareInsertAbitanteServlet" method="get"><input type="submit" value="nuovo"></form></td>
			</tr>
		</tfoot>
	</table>
